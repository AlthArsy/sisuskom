...
$sql = "SELECT a.id_apl1, a.id_asesi, a.judul_skema, a.nomor_skema,
               a.nama_pemohon, a.tanggal_pemohon, a.rekomendasi,
               asi.nama_asesi
        FROM tb_apl1 a
...
<div class="rekap-wrap">
    <div class="rekap-title">Permohonan Sertifikasi APL 1 </div>

    <div class="rekap-cards">
        <a href="<?= $base ?>?page=../list/permohonan.php&filter=belum"
    ...
    <?php if (empty($rows)): ?>
        <div class="empty-msg">Tidak ada data isini.</div>
    <?php else: ?>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td style="text-align:center; white-space:nowrap;">
                        <a class="btn-lihat"
                           href="<?= $base ?>?page=../FR_APL/FR_APL1.php&view=1&id_asesi=<?= $r['id_asesi'] ?>">
                        Lihat
                        </a>
                        <?php if (empty($r['rekomendasi'])): ?>
                        <a class="btn-rek"
