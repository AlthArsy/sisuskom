...
$forms = [
    [
        ...
        'isi'    => "../BERANDA/UTAMA.php?page=../FR_APL/FR_APL1.php&id_asesi=$id_asesi",
        'lihat'  => "../BERANDA/UTAMA.php?page=../FR_APL/FR_APL1.php&id_asesi=$id_asesi&view=1",
        'done'   => sudahIsi($koneksi, 'tb_apl1', 'id_asesi', $id_asesi),
    ],
    [
        'label'  => 'FR APL 2',
        'sub'    => 'Asesmen Mandiri',
        'isi'    => "../BERANDA/UTAMA.php?page=../FR_APL/FR_APL02.php&id_asesi=$id_asesi",
        'lihat'  => "../BERANDA/UTAMA.php?page=../FR_APL/FR_APL02.php&id_asesi=$id_asesi&view=1",
        'done'   => sudahIsi($koneksi, 'tb_apl2', 'id_asesi', $id_asesi),
    ],
    [
        'label'  => 'FR AK 1',
        'sub'    => 'Persetujuan Asesmen dan Kerahasiaan',
        'isi'    => "../BERANDA/UTAMA.php?page=../FR_APL/FR_AK01.php&id_asesi=$id_asesi",
        'lihat'  => "../BERANDA/UTAMA.php?page=../FR_APL/FR_AK01.php&id_asesi=$id_asesi&view=1",
    ...
    [
        ...
        'isi'    => "../BERANDA/UTAMA.php?page=../FR_APL/FR_AK03.php&id_asesi=$id_asesi",
        'lihat'  => "../BERANDA/UTAMA.php?page=../FR_APL/FR_AK03.php&id_asesi=$id_asesi&view=1",
    ...
    [
        ...
        'isi'    => "../BERANDA/UTAMA.php?page=../FR_APL/FR_IA06C.php&id_asesi=$id_asesi",
        'lihat'  => "../BERANDA/UTAMA.php?page=../FR_APL/FR_IA06C.php&id_asesi=$id_asesi&view=1",
