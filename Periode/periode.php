...
if (!isset($_SESSION['role']) || !in_array($_SESSION['role'], ['Admin_lsp', 'Admin_utm'])) {
...
<div class="konten-user">
    ...
    <form method="get" action="" class="cari">
        ...
        <div class="cari-actions">
            ...
            <?php endif; ?>
            <a href="../BERANDA/UTAMA.php?page=../Periode/tambah_pre.php" class="Tambah">
        ...
        <tbody>
            ...
            if (count($rows) > 0) {
                foreach ($rows as $row) {
                    ...
                    echo "<td data-label='Tahun Ajaran'>" . htmlspecialchars($row['tahun_ajaran'] ?? '') . "</td>";
                    echo "<td data-label='Aksi' class='aksi'>
                        <a href='UTAMA.php?page=../Periode/ubah_pre.php&id=" . $row['id_periode'] . "' class='btn-ubah'>Ubah</a>
                        <a href='../BERANDA/UTAMA.php?page=../Periode/hapus_pre.php&id=" . $row['id_periode'] . "'
                           class='btn-hapus'
