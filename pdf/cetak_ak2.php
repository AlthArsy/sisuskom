...
if ($id_asesi && $id_apl1_db) {
    $ak01 = mysqli_fetch_assoc(mysqli_query($koneksi,
        "SELECT COALESCE(CONVERT(j.tuk USING utf8mb4) COLLATE utf8mb4_unicode_ci, CONVERT(a.tuk_pelaksanaan USING utf8mb4) COLLATE utf8mb4_unicode_ci) AS tuk, a.hari_tanggal, a.id_ak01 FROM tb_ak01 a
