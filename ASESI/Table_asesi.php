...
$query_all = "SELECT * FROM tb_asesi ORDER BY nama_asesi ASC";
...
function confirmDelete(id, nama) {
    if (confirm("Apakah Anda yakin ingin menghapus data asesi:\n" + nama + "?")) {
        window.location.href = "../ASESI/hapus_asesi.php?id=" + id;
    }
    return false;
}
